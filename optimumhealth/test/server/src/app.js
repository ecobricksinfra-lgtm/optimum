...
const upload = require("../../../optimum/server/src/middlware/multer")
...
app.use(
    cors({
	    origin: ["http://localhost:5173","https://scintillating-douhua-3c2827.netlify.app","http://ec2-52-66-228-175.ap-south-1.compute.amazonaws.com:8080"],
        credentials: true,
    })
)
