...
const EditClinic = ({ editId, setEditId, setRefresh }) => {
    ...
    const onSubmit = async (data) => {
        try {
            ...
            const res = await axios.put(
                `http://ec2-52-66-228-175.ap-south-1.compute.amazonaws.com:3000/api/clinic/${editId}`,
                formData,
                {
                    headers: {
